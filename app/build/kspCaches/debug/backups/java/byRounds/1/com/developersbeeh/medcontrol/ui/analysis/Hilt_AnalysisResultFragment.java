...
public abstract class Hilt_AnalysisResultFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnalysisResultFragment() {
    super();
  }

  Hilt_AnalysisResultFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnalysisResultFragment_GeneratedInjector) this.generatedComponent()).injectAnalysisResultFragment(UnsafeCasts.<AnalysisResultFragment>unsafeCast(this));
    }
  }
