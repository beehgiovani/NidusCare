...
public abstract class Hilt_AddEditDependentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditDependentFragment() {
    super();
  }

  Hilt_AddEditDependentFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditDependentFragment_GeneratedInjector) this.generatedComponent()).injectAddEditDependentFragment(UnsafeCasts.<AddEditDependentFragment>unsafeCast(this));
    }
  }
