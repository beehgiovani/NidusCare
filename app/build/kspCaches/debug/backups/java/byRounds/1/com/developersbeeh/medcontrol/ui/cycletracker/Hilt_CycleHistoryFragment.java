...
public abstract class Hilt_CycleHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CycleHistoryFragment() {
    super();
  }

  Hilt_CycleHistoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CycleHistoryFragment_GeneratedInjector) this.generatedComponent()).injectCycleHistoryFragment(UnsafeCasts.<CycleHistoryFragment>unsafeCast(this));
    }
  }
