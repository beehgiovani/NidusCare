...
public abstract class Hilt_EditSelfProfileHealthFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditSelfProfileHealthFragment() {
    super();
  }

  Hilt_EditSelfProfileHealthFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditSelfProfileHealthFragment_GeneratedInjector) this.generatedComponent()).injectEditSelfProfileHealthFragment(UnsafeCasts.<EditSelfProfileHealthFragment>unsafeCast(this));
    }
  }
