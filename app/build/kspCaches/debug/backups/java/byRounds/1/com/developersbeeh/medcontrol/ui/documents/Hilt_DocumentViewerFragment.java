...
public abstract class Hilt_DocumentViewerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DocumentViewerFragment() {
    super();
  }

  Hilt_DocumentViewerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DocumentViewerFragment_GeneratedInjector) this.generatedComponent()).injectDocumentViewerFragment(UnsafeCasts.<DocumentViewerFragment>unsafeCast(this));
    }
  }
