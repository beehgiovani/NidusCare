...
public abstract class Hilt_ScanAndConfirmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScanAndConfirmFragment() {
    super();
  }

  Hilt_ScanAndConfirmFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScanAndConfirmFragment_GeneratedInjector) this.generatedComponent()).injectScanAndConfirmFragment(UnsafeCasts.<ScanAndConfirmFragment>unsafeCast(this));
    }
  }
