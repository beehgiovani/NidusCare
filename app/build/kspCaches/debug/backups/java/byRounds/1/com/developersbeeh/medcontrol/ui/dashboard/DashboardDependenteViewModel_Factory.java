...
public final class DashboardDependenteViewModel_Factory implements Factory<DashboardDependenteViewModel> {
  ...
  public DashboardDependenteViewModel get() {
    return newInstance(firestoreRepositoryProvider.get(), userRepositoryProvider.get(), medicationRepositoryProvider.get(), scheduleRepositoryProvider.get(), reminderRepositoryProvider.get(), userPreferencesProvider.get(), applicationProvider.get());
  }
  ...
  public static DashboardDependenteViewModel_Factory create(
      ...
      Provider<UserPreferences> userPreferencesProvider,
      Provider<Application> applicationProvider) {
    return new DashboardDependenteViewModel_Factory(firestoreRepositoryProvider, userRepositoryProvider, medicationRepositoryProvider, scheduleRepositoryProvider, reminderRepositoryProvider, userPreferencesProvider, applicationProvider);
  }
  ...
  public static DashboardDependenteViewModel newInstance(FirestoreRepository firestoreRepository,
      ...
      UserPreferences userPreferences, Application application) {
    return new DashboardDependenteViewModel(firestoreRepository, userRepository, medicationRepository, scheduleRepository, reminderRepository, userPreferences, application);
  }
}
