...
public abstract class Hilt_VaccinationCardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VaccinationCardFragment() {
    super();
  }

  Hilt_VaccinationCardFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VaccinationCardFragment_GeneratedInjector) this.generatedComponent()).injectVaccinationCardFragment(UnsafeCasts.<VaccinationCardFragment>unsafeCast(this));
    }
  }
