...
public abstract class Hilt_PrescriptionAnalysisFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrescriptionAnalysisFragment() {
    super();
  }

  Hilt_PrescriptionAnalysisFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrescriptionAnalysisFragment_GeneratedInjector) this.generatedComponent()).injectPrescriptionAnalysisFragment(UnsafeCasts.<PrescriptionAnalysisFragment>unsafeCast(this));
    }
  }
