...
public abstract class Hilt_HealthNotesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthNotesFragment() {
    super();
  }

  Hilt_HealthNotesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthNotesFragment_GeneratedInjector) this.generatedComponent()).injectHealthNotesFragment(UnsafeCasts.<HealthNotesFragment>unsafeCast(this));
    }
  }
