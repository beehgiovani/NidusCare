...
public abstract class Hilt_ManageFamilyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManageFamilyFragment() {
    super();
  }

  Hilt_ManageFamilyFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManageFamilyFragment_GeneratedInjector) this.generatedComponent()).injectManageFamilyFragment(UnsafeCasts.<ManageFamilyFragment>unsafeCast(this));
    }
  }
