...
public abstract class Hilt_AddMedicamentoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddMedicamentoFragment() {
    super();
  }

  Hilt_AddMedicamentoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddMedicamentoFragment_GeneratedInjector) this.generatedComponent()).injectAddMedicamentoFragment(UnsafeCasts.<AddMedicamentoFragment>unsafeCast(this));
    }
  }
