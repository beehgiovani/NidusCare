...
public abstract class Hilt_PharmacySelectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PharmacySelectionFragment() {
    super();
  }

  Hilt_PharmacySelectionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PharmacySelectionFragment_GeneratedInjector) this.generatedComponent()).injectPharmacySelectionFragment(UnsafeCasts.<PharmacySelectionFragment>unsafeCast(this));
    }
  }
