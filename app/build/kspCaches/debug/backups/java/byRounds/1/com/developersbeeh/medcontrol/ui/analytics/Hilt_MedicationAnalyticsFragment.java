...
public abstract class Hilt_MedicationAnalyticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MedicationAnalyticsFragment() {
    super();
  }

  Hilt_MedicationAnalyticsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedicationAnalyticsFragment_GeneratedInjector) this.generatedComponent()).injectMedicationAnalyticsFragment(UnsafeCasts.<MedicationAnalyticsFragment>unsafeCast(this));
    }
  }
