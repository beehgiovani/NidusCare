...
public class MealAnalysisResultJsonAdapter(
  ...
  public override fun fromJson(reader: JsonReader): MealAnalysisResult {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        4 -> {
          tipoRefeicao = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("tipoRefeicao",
              "tipoRefeicao", reader)
    ...
    if (mask0 == 0xffffffe0.toInt()) {
      ...
      return  MealAnalysisResult(
          ...
          tipoRefeicao = tipoRefeicao as String
      )
    } else {
  ...
  public override fun toJson(writer: JsonWriter, value_: MealAnalysisResult?): Unit {
    ...
    writer.name("tipoRefeicao")
    stringAdapter.toJson(writer, value_.tipoRefeicao)
    writer.endObject()
  }
}
