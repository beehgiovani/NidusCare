...
public abstract class Hilt_CaregiverDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CaregiverDashboardFragment() {
    super();
  }

  Hilt_CaregiverDashboardFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CaregiverDashboardFragment_GeneratedInjector) this.generatedComponent()).injectCaregiverDashboardFragment(UnsafeCasts.<CaregiverDashboardFragment>unsafeCast(this));
    }
  }
