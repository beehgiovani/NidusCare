...
public abstract class Hilt_CycleTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CycleTrackerFragment() {
    super();
  }

  Hilt_CycleTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CycleTrackerFragment_GeneratedInjector) this.generatedComponent()).injectCycleTrackerFragment(UnsafeCasts.<CycleTrackerFragment>unsafeCast(this));
    }
  }
