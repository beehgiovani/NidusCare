...
public abstract class Hilt_EducationCenterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EducationCenterFragment() {
    super();
  }

  Hilt_EducationCenterFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EducationCenterFragment_GeneratedInjector) this.generatedComponent()).injectEducationCenterFragment(UnsafeCasts.<EducationCenterFragment>unsafeCast(this));
    }
  }
