...
public abstract class Hilt_LinkDependentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LinkDependentFragment() {
    super();
  }

  Hilt_LinkDependentFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LinkDependentFragment_GeneratedInjector) this.generatedComponent()).injectLinkDependentFragment(UnsafeCasts.<LinkDependentFragment>unsafeCast(this));
    }
  }
