...
public abstract class Hilt_EducationDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EducationDetailFragment() {
    super();
  }

  Hilt_EducationDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EducationDetailFragment_GeneratedInjector) this.generatedComponent()).injectEducationDetailFragment(UnsafeCasts.<EducationDetailFragment>unsafeCast(this));
    }
  }
