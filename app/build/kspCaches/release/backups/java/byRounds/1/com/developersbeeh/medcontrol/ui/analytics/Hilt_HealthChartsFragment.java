...
public abstract class Hilt_HealthChartsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthChartsFragment() {
    super();
  }

  Hilt_HealthChartsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthChartsFragment_GeneratedInjector) this.generatedComponent()).injectHealthChartsFragment(UnsafeCasts.<HealthChartsFragment>unsafeCast(this));
    }
  }
