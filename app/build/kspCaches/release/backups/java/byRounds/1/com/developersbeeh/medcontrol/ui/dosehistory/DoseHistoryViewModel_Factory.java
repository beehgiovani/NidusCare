...
public final class DoseHistoryViewModel_Factory implements Factory<DoseHistoryViewModel> {
  ...
  private DoseHistoryViewModel_Factory(
  ...
  public static DoseHistoryViewModel_Factory create(
      Provider<MedicationRepository> medicationRepositoryProvider) {
    return new DoseHistoryViewModel_Factory(medicationRepositoryProvider);
  }

  public static DoseHistoryViewModel newInstance(MedicationRepository medicationRepository) {
    return new DoseHistoryViewModel(medicationRepository);
  }
}
