...
public abstract class Hilt_ReceivedInvitesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReceivedInvitesFragment() {
    super();
  }

  Hilt_ReceivedInvitesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReceivedInvitesFragment_GeneratedInjector) this.generatedComponent()).injectReceivedInvitesFragment(UnsafeCasts.<ReceivedInvitesFragment>unsafeCast(this));
    }
  }
