...
public abstract class Hilt_ListMedicamentosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListMedicamentosFragment() {
    super();
  }

  Hilt_ListMedicamentosFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListMedicamentosFragment_GeneratedInjector) this.generatedComponent()).injectListMedicamentosFragment(UnsafeCasts.<ListMedicamentosFragment>unsafeCast(this));
    }
  }
