...
public class SearchMedicamentosFragmentDirections private constructor() {
  private data class ActionSearchMedicamentosFragmentToMedicamentoDetailFragment(
    public val medicamento: Medicamento,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_searchMedicamentosFragment_to_medicamentoDetailFragment
  ...
  public companion object {
    public
        fun actionSearchMedicamentosFragmentToMedicamentoDetailFragment(medicamento: Medicamento):
        NavDirections = ActionSearchMedicamentosFragmentToMedicamentoDetailFragment(medicamento)
