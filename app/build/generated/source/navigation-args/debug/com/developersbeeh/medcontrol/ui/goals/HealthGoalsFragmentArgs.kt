...
public data class HealthGoalsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HealthGoalsFragmentArgs {
      bundle.setClassLoader(HealthGoalsFragmentArgs::class.java.classLoader)
      ...
      return HealthGoalsFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HealthGoalsFragmentArgs {
      val __dependentId : String?
