...
public data class MedicamentoDetailFragmentArgs(
  public val medicamento: Medicamento,
) : NavArgs {
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): MedicamentoDetailFragmentArgs {
      bundle.setClassLoader(MedicamentoDetailFragmentArgs::class.java.classLoader)
      ...
      if (bundle.containsKey("medicamento")) {
        ...
        if (__medicamento == null) {
          throw IllegalArgumentException("Argument \"medicamento\" is marked as non-null but was passed a null value.")
        }
      } else {
        throw IllegalArgumentException("Required argument \"medicamento\" is missing and does not have an android:defaultValue")
      }
      return MedicamentoDetailFragmentArgs(__medicamento)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        MedicamentoDetailFragmentArgs {
      val __medicamento : Medicamento?
