...
public class EducationCenterFragmentDirections private constructor() {
  private data class ActionEducationCenterFragmentToEducationDetailFragment(
    public val artigo: ArtigoEducativo,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_educationCenterFragment_to_educationDetailFragment
  ...
  public companion object {
    public fun actionEducationCenterFragmentToEducationDetailFragment(artigo: ArtigoEducativo):
        NavDirections = ActionEducationCenterFragmentToEducationDetailFragment(artigo)
