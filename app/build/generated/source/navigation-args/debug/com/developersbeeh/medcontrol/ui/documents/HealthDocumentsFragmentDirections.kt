...
public class HealthDocumentsFragmentDirections private constructor() {
  private data class ActionHealthDocumentsFragmentToAddEditDocumentFragment(
    public val dependentId: String,
    public val dependentName: String,
    public val documento: DocumentoSaude? = null,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_healthDocumentsFragment_to_addEditDocumentFragment
  ...
  private data class ActionHealthDocumentsFragmentToDocumentViewerFragment(
    public val documentoUrl: String,
    public val documentoTitulo: String,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_healthDocumentsFragment_to_documentViewerFragment
  ...
  public companion object {
    public fun actionHealthDocumentsFragmentToAddEditDocumentFragment(
      dependentId: String,
      dependentName: String,
      documento: DocumentoSaude? = null,
    ): NavDirections = ActionHealthDocumentsFragmentToAddEditDocumentFragment(dependentId,
        dependentName, documento)

    public fun actionHealthDocumentsFragmentToDocumentViewerFragment(documentoUrl: String,
        documentoTitulo: String): NavDirections =
        ActionHealthDocumentsFragmentToDocumentViewerFragment(documentoUrl, documentoTitulo)
