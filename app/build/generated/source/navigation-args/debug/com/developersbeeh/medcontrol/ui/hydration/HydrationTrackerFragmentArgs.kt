...
public data class HydrationTrackerFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HydrationTrackerFragmentArgs {
      bundle.setClassLoader(HydrationTrackerFragmentArgs::class.java.classLoader)
      ...
      return HydrationTrackerFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        HydrationTrackerFragmentArgs {
      val __dependentId : String?
