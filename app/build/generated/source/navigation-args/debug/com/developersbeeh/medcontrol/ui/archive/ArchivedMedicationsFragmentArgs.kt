...
public data class ArchivedMedicationsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ArchivedMedicationsFragmentArgs {
      bundle.setClassLoader(ArchivedMedicationsFragmentArgs::class.java.classLoader)
      ...
      return ArchivedMedicationsFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ArchivedMedicationsFragmentArgs {
      val __dependentId : String?
