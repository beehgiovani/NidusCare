...
public class PrescriptionScannerFragmentDirections private constructor() {
  private data class ActionPrescriptionScannerFragmentToPrescriptionAnalysisFragment(
    public val dependentId: String,
    public val dependentName: String,
    public val imageUri: String,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_prescriptionScannerFragment_to_prescriptionAnalysisFragment
  ...
  public companion object {
    public fun actionPrescriptionScannerFragmentToPrescriptionAnalysisFragment(
      dependentId: String,
      dependentName: String,
      imageUri: String,
    ): NavDirections = ActionPrescriptionScannerFragmentToPrescriptionAnalysisFragment(dependentId,
        dependentName, imageUri)
