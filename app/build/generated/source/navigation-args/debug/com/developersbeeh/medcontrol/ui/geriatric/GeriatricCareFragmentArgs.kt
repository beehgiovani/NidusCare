...
public data class GeriatricCareFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): GeriatricCareFragmentArgs {
      bundle.setClassLoader(GeriatricCareFragmentArgs::class.java.classLoader)
      ...
      return GeriatricCareFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): GeriatricCareFragmentArgs {
      val __dependentId : String?
