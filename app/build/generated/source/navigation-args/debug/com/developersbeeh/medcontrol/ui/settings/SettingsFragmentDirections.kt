...
public class SettingsFragmentDirections private constructor() {
  public companion object {
    public fun actionSettingsFragmentToNotificationSettingsFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_settingsFragment_to_notificationSettingsFragment)

    public fun actionSettingsFragmentToPrivacySettingsFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_settingsFragment_to_privacySettingsFragment)

    public fun actionSettingsFragmentToThemeSettingsFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_settingsFragment_to_themeSettingsFragment)
