...
public data class HealthNotesFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HealthNotesFragmentArgs {
      bundle.setClassLoader(HealthNotesFragmentArgs::class.java.classLoader)
      ...
      return HealthNotesFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HealthNotesFragmentArgs {
      val __dependentId : String?
