...
public class LinkDependentFragmentDirections private constructor() {
  private data class ActionLinkDependentFragmentToDashboardDependenteFragment(
    public val dependentId: String,
    public val dependentName: String,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_linkDependentFragment_to_dashboardDependenteFragment
  ...
  public companion object {
    public fun actionLinkDependentFragmentToDashboardDependenteFragment(dependentId: String,
        dependentName: String): NavDirections =
        ActionLinkDependentFragmentToDashboardDependenteFragment(dependentId, dependentName)
