...
public data class HealthDocumentsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HealthDocumentsFragmentArgs {
      bundle.setClassLoader(HealthDocumentsFragmentArgs::class.java.classLoader)
      ...
      return HealthDocumentsFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        HealthDocumentsFragmentArgs {
      val __dependentId : String?
