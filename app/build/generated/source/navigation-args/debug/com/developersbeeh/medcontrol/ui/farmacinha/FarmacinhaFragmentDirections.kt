...
public class FarmacinhaFragmentDirections private constructor() {
  private data class ActionFarmacinhaFragmentToAddMedicamentoFragment(
    ...
    public override val actionId: Int = R.id.action_farmacinhaFragment_to_addMedicamentoFragment
  ...
  private data class ActionFarmacinhaFragmentToScanAndConfirmFragment(
    public val dependentId: String?,
    public val dependentName: String?,
    public val title: String = "Escanear Medicamento",
  ) : NavDirections {
    public override val actionId: Int = R.id.action_farmacinhaFragment_to_scanAndConfirmFragment
  ...
  public companion object {
    public fun actionFarmacinhaFragmentToAddMedicamentoFragment(
      dependentId: String,
      dependentName: String,
      isCaregiver: Boolean,
      medicamento: Medicamento? = null,
    ): NavDirections = ActionFarmacinhaFragmentToAddMedicamentoFragment(dependentId, dependentName,
        isCaregiver, medicamento)

    public fun actionFarmacinhaFragmentToScanAndConfirmFragment(
      dependentId: String?,
      dependentName: String?,
      title: String = "Escanear Medicamento",
    ): NavDirections = ActionFarmacinhaFragmentToScanAndConfirmFragment(dependentId, dependentName,
        title)
