...
public data class WellbeingDiaryFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): WellbeingDiaryFragmentArgs {
      bundle.setClassLoader(WellbeingDiaryFragmentArgs::class.java.classLoader)
      ...
      return WellbeingDiaryFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        WellbeingDiaryFragmentArgs {
      val __dependentId : String?
