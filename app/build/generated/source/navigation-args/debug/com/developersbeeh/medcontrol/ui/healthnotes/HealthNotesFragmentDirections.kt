...
public class HealthNotesFragmentDirections private constructor() {
  private data class ActionHealthNotesFragmentToAddHealthNoteFragment(
    public val dependentId: String,
    public val dependentName: String,
    public val healthNoteToEdit: HealthNote? = null,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_healthNotesFragment_to_addHealthNoteFragment
  ...
  private data class ActionHealthNotesFragmentToHealthChartsFragment(
    public val dependentId: String,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_healthNotesFragment_to_healthChartsFragment
  ...
  public companion object {
    public fun actionHealthNotesFragmentToAddHealthNoteFragment(
      dependentId: String,
      dependentName: String,
      healthNoteToEdit: HealthNote? = null,
    ): NavDirections = ActionHealthNotesFragmentToAddHealthNoteFragment(dependentId, dependentName,
        healthNoteToEdit)

    public fun actionHealthNotesFragmentToHealthChartsFragment(dependentId: String): NavDirections =
        ActionHealthNotesFragmentToHealthChartsFragment(dependentId)
