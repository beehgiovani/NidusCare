...
public data class InsightsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): InsightsFragmentArgs {
      bundle.setClassLoader(InsightsFragmentArgs::class.java.classLoader)
      ...
      return InsightsFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): InsightsFragmentArgs {
      val __dependentId : String?
