...
public class GeriatricCareFragmentDirections private constructor() {
  private data class ActionGeriatricCareFragmentToEducationDetailFragment(
    public val artigo: ArtigoEducativo,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_geriatricCareFragment_to_educationDetailFragment
  ...
  public companion object {
    public fun actionGeriatricCareFragmentToEducationDetailFragment(artigo: ArtigoEducativo):
        NavDirections = ActionGeriatricCareFragmentToEducationDetailFragment(artigo)
