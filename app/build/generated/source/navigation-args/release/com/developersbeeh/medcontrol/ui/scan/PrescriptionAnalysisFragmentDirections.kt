...
public class PrescriptionAnalysisFragmentDirections private constructor() {
  private data class ActionPrescriptionAnalysisFragmentToAddMedicamentoFragment(
    ...
    public override val actionId: Int =
        R.id.action_prescriptionAnalysisFragment_to_addMedicamentoFragment
  ...
  public companion object {
    public fun actionPrescriptionAnalysisFragmentToAddMedicamentoFragment(
      dependentId: String,
      dependentName: String,
      isCaregiver: Boolean,
      medicamento: Medicamento? = null,
    ): NavDirections = ActionPrescriptionAnalysisFragmentToAddMedicamentoFragment(dependentId,
