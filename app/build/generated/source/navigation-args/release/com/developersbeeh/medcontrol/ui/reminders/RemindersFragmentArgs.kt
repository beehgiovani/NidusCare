...
public data class RemindersFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): RemindersFragmentArgs {
      bundle.setClassLoader(RemindersFragmentArgs::class.java.classLoader)
      ...
      return RemindersFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): RemindersFragmentArgs {
      val __dependentId : String?
