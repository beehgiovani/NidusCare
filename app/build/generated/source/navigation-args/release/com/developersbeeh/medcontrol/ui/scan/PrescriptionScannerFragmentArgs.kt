...
public data class PrescriptionScannerFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): PrescriptionScannerFragmentArgs {
      bundle.setClassLoader(PrescriptionScannerFragmentArgs::class.java.classLoader)
      ...
      return PrescriptionScannerFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        PrescriptionScannerFragmentArgs {
      val __dependentId : String?
