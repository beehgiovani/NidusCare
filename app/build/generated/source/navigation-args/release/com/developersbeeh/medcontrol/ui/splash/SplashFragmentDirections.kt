...
public class SplashFragmentDirections private constructor() {
  ...
  public companion object {
    public fun actionSplashFragmentToRoleSelectionFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_splashFragment_to_roleSelectionFragment)

    public fun actionSplashFragmentToCaregiverDashboardFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_splashFragment_to_caregiverDashboardFragment)
    ...
    public fun actionSplashFragmentToOnboardingFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_splashFragment_to_onboardingFragment)
