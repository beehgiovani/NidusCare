...
public data class ReportsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ReportsFragmentArgs {
      bundle.setClassLoader(ReportsFragmentArgs::class.java.classLoader)
      ...
      return ReportsFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ReportsFragmentArgs {
      val __dependentId : String?
