...
public class PharmacySelectionFragmentDirections private constructor() {
  private data class ActionPharmacySelectionFragmentToPharmacyMedicationSelectionFragment(
    public val pharmacyName: String,
    public val pharmacyPhoneNumber: String,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_pharmacySelectionFragment_to_pharmacyMedicationSelectionFragment
  ...
  public companion object {
    public
        fun actionPharmacySelectionFragmentToPharmacyMedicationSelectionFragment(pharmacyName: String,
        pharmacyPhoneNumber: String): NavDirections =
        ActionPharmacySelectionFragmentToPharmacyMedicationSelectionFragment(pharmacyName,
        pharmacyPhoneNumber)
