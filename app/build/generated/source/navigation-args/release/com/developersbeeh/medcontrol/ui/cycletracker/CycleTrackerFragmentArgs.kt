...
public data class CycleTrackerFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): CycleTrackerFragmentArgs {
      bundle.setClassLoader(CycleTrackerFragmentArgs::class.java.classLoader)
      ...
      return CycleTrackerFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): CycleTrackerFragmentArgs {
      val __dependentId : String?
