...
public data class TimelineFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): TimelineFragmentArgs {
      bundle.setClassLoader(TimelineFragmentArgs::class.java.classLoader)
      ...
      return TimelineFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): TimelineFragmentArgs {
      val __dependentId : String?
