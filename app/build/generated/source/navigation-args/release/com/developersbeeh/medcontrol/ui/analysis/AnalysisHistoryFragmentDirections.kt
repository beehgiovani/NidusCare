...
public class AnalysisHistoryFragmentDirections private constructor() {
  private data class ActionAnalysisHistoryFragmentToAnalysisResultFragment(
    ...
    public override val actionId: Int =
        R.id.action_analysisHistoryFragment_to_analysisResultFragment
  ...
  public companion object {
    public fun actionAnalysisHistoryFragmentToAnalysisResultFragment(
      prompt: String,
      dependentId: String,
      dependentName: String,
      analysisResult: String? = null,
    ): NavDirections = ActionAnalysisHistoryFragmentToAnalysisResultFragment(prompt, dependentId,
