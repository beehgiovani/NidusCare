...
public data class DoseHistoryFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DoseHistoryFragmentArgs {
      bundle.setClassLoader(DoseHistoryFragmentArgs::class.java.classLoader)
      ...
      return DoseHistoryFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): DoseHistoryFragmentArgs {
      val __dependentId : String?
