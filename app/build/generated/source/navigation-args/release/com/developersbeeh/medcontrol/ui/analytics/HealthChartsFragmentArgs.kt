...
public data class HealthChartsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HealthChartsFragmentArgs {
      bundle.setClassLoader(HealthChartsFragmentArgs::class.java.classLoader)
      ...
      return HealthChartsFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HealthChartsFragmentArgs {
      val __dependentId : String?
