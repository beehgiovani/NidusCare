...
public data class DependentDiaryFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DependentDiaryFragmentArgs {
      bundle.setClassLoader(DependentDiaryFragmentArgs::class.java.classLoader)
      ...
      return DependentDiaryFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        DependentDiaryFragmentArgs {
      val __dependentId : String?
