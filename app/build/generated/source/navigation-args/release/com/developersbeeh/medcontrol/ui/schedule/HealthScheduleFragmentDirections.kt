...
public class HealthScheduleFragmentDirections private constructor() {
  private data class ActionHealthScheduleFragmentToAddEditScheduleFragment(
    public val dependentId: String,
    public val dependentName: String,
    public val agendamento: AgendamentoSaude? = null,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_healthScheduleFragment_to_addEditScheduleFragment
  ...
  public companion object {
    public fun actionHealthScheduleFragmentToAddEditScheduleFragment(
      dependentId: String,
      dependentName: String,
      agendamento: AgendamentoSaude? = null,
    ): NavDirections = ActionHealthScheduleFragmentToAddEditScheduleFragment(dependentId,
        dependentName, agendamento)
