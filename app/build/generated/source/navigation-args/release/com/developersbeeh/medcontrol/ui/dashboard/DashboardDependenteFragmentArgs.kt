...
public data class DashboardDependenteFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DashboardDependenteFragmentArgs {
      bundle.setClassLoader(DashboardDependenteFragmentArgs::class.java.classLoader)
      ...
      return DashboardDependenteFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        DashboardDependenteFragmentArgs {
      val __dependentId : String?
