...
public data class AchievementsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AchievementsFragmentArgs {
      bundle.setClassLoader(AchievementsFragmentArgs::class.java.classLoader)
      ...
      return AchievementsFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): AchievementsFragmentArgs {
      val __dependentId : String?
