...
public data class AnalysisHistoryFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AnalysisHistoryFragmentArgs {
      bundle.setClassLoader(AnalysisHistoryFragmentArgs::class.java.classLoader)
      ...
      return AnalysisHistoryFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        AnalysisHistoryFragmentArgs {
      val __dependentId : String?
