...
public class RoleSelectionFragmentDirections private constructor() {
  public companion object {
    public fun actionRoleSelectionFragmentToLoginFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_roleSelectionFragment_to_loginFragment)

    public fun actionRoleSelectionFragmentToLinkDependentFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_roleSelectionFragment_to_linkDependentFragment)
