...
public data class WeightTrackerFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): WeightTrackerFragmentArgs {
      bundle.setClassLoader(WeightTrackerFragmentArgs::class.java.classLoader)
      ...
      return WeightTrackerFragmentArgs(__dependentId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): WeightTrackerFragmentArgs {
      val __dependentId : String?
