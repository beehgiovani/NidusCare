...
public data class HealthScheduleFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HealthScheduleFragmentArgs {
      bundle.setClassLoader(HealthScheduleFragmentArgs::class.java.classLoader)
      ...
      return HealthScheduleFragmentArgs(__dependentId, __dependentName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        HealthScheduleFragmentArgs {
      val __dependentId : String?
