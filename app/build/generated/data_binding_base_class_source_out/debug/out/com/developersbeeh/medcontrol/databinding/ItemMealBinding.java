...
public final class ItemMealBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textViewMealType;

  private ItemMealBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageViewIcon,
      @NonNull TextView textViewCalories, @NonNull TextView textViewDescription,
      @NonNull TextView textViewMealType) {
    this.rootView = rootView;
    this.imageViewIcon = imageViewIcon;
    this.textViewCalories = textViewCalories;
    this.textViewDescription = textViewDescription;
    this.textViewMealType = textViewMealType;
  }
  ...
  public static ItemMealBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewMealType;
      TextView textViewMealType = ViewBindings.findChildViewById(rootView, id);
      if (textViewMealType == null) {
        break missingId;
      }

      return new ItemMealBinding((ConstraintLayout) rootView, imageViewIcon, textViewCalories,
          textViewDescription, textViewMealType);
    }
