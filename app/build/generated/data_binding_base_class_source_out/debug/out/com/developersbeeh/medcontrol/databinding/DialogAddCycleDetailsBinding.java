...
public final class DialogAddCycleDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private DialogAddCycleDetailsBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static DialogAddCycleDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogAddCycleDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_add_cycle_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogAddCycleDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddCycleDetailsBinding((ScrollView) rootView, editTextBasalTemperature,
