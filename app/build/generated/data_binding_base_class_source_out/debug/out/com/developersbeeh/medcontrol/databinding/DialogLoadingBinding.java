...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView,
      @NonNull LottieAnimationView lottieAnimationView, @NonNull TextView textViewLoadingMessage) {
    this.rootView = rootView;
    this.lottieAnimationView = lottieAnimationView;
    this.textViewLoadingMessage = textViewLoadingMessage;
  }
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewLoadingMessage;
      TextView textViewLoadingMessage = ViewBindings.findChildViewById(rootView, id);
      if (textViewLoadingMessage == null) {
        break missingId;
      }

      return new DialogLoadingBinding((LinearLayout) rootView, lottieAnimationView,
          textViewLoadingMessage);
    }
