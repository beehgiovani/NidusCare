...
public final class LayoutDependentPermissionsBinding implements ViewBinding {
  ...
  @NonNull
  public final SwitchMaterial switchCanAddSchedules;

  @NonNull
  public final SwitchMaterial switchCanEditSchedules;
  ...
  private LayoutDependentPermissionsBinding(@NonNull LinearLayout rootView,
      @NonNull SwitchMaterial switchCanAddDocuments, @NonNull SwitchMaterial switchCanAddSchedules,
      @NonNull SwitchMaterial switchCanEditSchedules, @NonNull SwitchMaterial switchCanRegisterDose,
    ...
    this.switchCanAddSchedules = switchCanAddSchedules;
    this.switchCanEditSchedules = switchCanEditSchedules;
  ...
  public static LayoutDependentPermissionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.switchCanAddSchedules;
      SwitchMaterial switchCanAddSchedules = ViewBindings.findChildViewById(rootView, id);
      if (switchCanAddSchedules == null) {
        break missingId;
      }

      id = R.id.switchCanEditSchedules;
      SwitchMaterial switchCanEditSchedules = ViewBindings.findChildViewById(rootView, id);
      if (switchCanEditSchedules == null) {
        break missingId;
      }
      ...
      return new LayoutDependentPermissionsBinding((LinearLayout) rootView, switchCanAddDocuments,
          switchCanAddSchedules, switchCanEditSchedules, switchCanRegisterDose,
          switchCanRegisterNotes, switchCanSeeAgenda, switchCanSeeDocuments);
    }
