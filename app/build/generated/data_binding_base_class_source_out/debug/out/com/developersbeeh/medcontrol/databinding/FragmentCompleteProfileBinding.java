...
public final class FragmentCompleteProfileBinding implements ViewBinding {
  ...
  private FragmentCompleteProfileBinding(@NonNull ScrollView rootView,
      @NonNull AutoCompleteTextView autoCompleteSexo,
      @NonNull AutoCompleteTextView autoCompleteTipoSanguineo, @NonNull MaterialButton buttonSave,
      ...
      @NonNull ProgressBar progressBar, @NonNull TextView textViewPasswordInfo,
    ...
    this.textViewPasswordInfo = textViewPasswordInfo;
  ...
  public static FragmentCompleteProfileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_complete_profile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCompleteProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewPasswordInfo;
      TextView textViewPasswordInfo = ViewBindings.findChildViewById(rootView, id);
      if (textViewPasswordInfo == null) {
        break missingId;
      }
      ...
      return new FragmentCompleteProfileBinding((ScrollView) rootView, autoCompleteSexo,
          autoCompleteTipoSanguineo, buttonSave, editTextAllergies, editTextAltura,
          editTextConditions, editTextConfirmPassword, editTextDob, editTextPassword,
          editTextWeight, progressBar, textViewPasswordInfo, textViewSubtitle, textViewTitle,
          tilAllergies, tilAltura, tilConditions, tilConfirmPassword, tilDob, tilPassword, tilSexo,
