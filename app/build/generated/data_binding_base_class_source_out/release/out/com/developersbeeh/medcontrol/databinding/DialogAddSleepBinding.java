...
public final class DialogAddSleepBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView labelInterruptions;

  @NonNull
  public final TextView labelQuality;

  @NonNull
  public final LinearLayout layoutInterruptions;
  ...
  private DialogAddSleepBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextInputEditText editTextBedtime, @NonNull TextInputEditText editTextNotes,
      @NonNull TextInputEditText editTextWakeUp, @NonNull TextView labelInterruptions,
      @NonNull TextView labelQuality, @NonNull LinearLayout layoutInterruptions,
      @NonNull TextView textViewInterruptionsCount, @NonNull TextInputLayout tilBedtime,
      @NonNull TextInputLayout tilNotes, @NonNull TextInputLayout tilWakeUp) {
    ...
    this.labelInterruptions = labelInterruptions;
    this.labelQuality = labelQuality;
    this.layoutInterruptions = layoutInterruptions;
  ...
  public static DialogAddSleepBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.labelInterruptions;
      TextView labelInterruptions = ViewBindings.findChildViewById(rootView, id);
      if (labelInterruptions == null) {
        break missingId;
      }

      id = R.id.labelQuality;
      TextView labelQuality = ViewBindings.findChildViewById(rootView, id);
      if (labelQuality == null) {
        break missingId;
      }

      id = R.id.layoutInterruptions;
      LinearLayout layoutInterruptions = ViewBindings.findChildViewById(rootView, id);
      if (layoutInterruptions == null) {
        break missingId;
      }
      ...
      return new DialogAddSleepBinding((ScrollView) rootView, buttonAddInterruption,
          ...
          chipQualityGood, chipQualityOk, editTextBedtime, editTextNotes, editTextWakeUp,
          labelInterruptions, labelQuality, layoutInterruptions, textViewInterruptionsCount,
          tilBedtime, tilNotes, tilWakeUp);
    }
