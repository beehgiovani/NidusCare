...
public final class CaregiverDashboardItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView iconMissedDose;
  ...
  @NonNull
  public final TextView labelMissedDose;
  ...
  @NonNull
  public final LinearLayout missedDoseLayout;
  ...
  private CaregiverDashboardItemBinding(@NonNull MaterialCardView rootView,
      ...
      @NonNull ImageView iconLowStock, @NonNull ImageView iconMissedDose,
      @NonNull ShapeableImageView imageViewAvatar, @NonNull ImageView imageViewExpandCollapse,
      @NonNull ImageView imageViewInsightIcon, @NonNull ImageView imageViewStreakIcon,
      @NonNull MaterialCardView insightPreviewCard, @NonNull TextView labelAppointmentToday,
      @NonNull TextView labelLowStock, @NonNull TextView labelMissedDose,
      @NonNull LinearLayout lowStockLayout, @NonNull ConstraintLayout mainContentLayout,
      @NonNull LinearLayout missedDoseLayout, @NonNull ProgressBar progressAdherence,
      @NonNull LinearProgressIndicator progressToday, @NonNull View statusBar,
      @NonNull LinearLayout statusIndicatorsLayout, @NonNull LinearLayout streakLayout,
      @NonNull TextView textViewAdherenceLabel, @NonNull TextView textViewAdherencePercentage,
      @NonNull TextView textViewAgeAndSex, @NonNull TextView textViewDependentName,
      @NonNull TextView textViewInsightCount, @NonNull TextView textViewInsightPreview,
      @NonNull TextView textViewInsightTitle, @NonNull TextView textViewNextDose,
      @NonNull TextView textViewStreakCount, @NonNull TextView textViewTodayProgressLabel) {
    ...
    this.iconMissedDose = iconMissedDose;
    ...
    this.labelMissedDose = labelMissedDose;
    this.lowStockLayout = lowStockLayout;
    this.mainContentLayout = mainContentLayout;
    this.missedDoseLayout = missedDoseLayout;
  ...
  public static CaregiverDashboardItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.iconMissedDose;
      ImageView iconMissedDose = ViewBindings.findChildViewById(rootView, id);
      if (iconMissedDose == null) {
        break missingId;
      }
      ...
      id = R.id.labelMissedDose;
      TextView labelMissedDose = ViewBindings.findChildViewById(rootView, id);
      if (labelMissedDose == null) {
        break missingId;
      }
      ...
      id = R.id.missedDoseLayout;
      LinearLayout missedDoseLayout = ViewBindings.findChildViewById(rootView, id);
      if (missedDoseLayout == null) {
        break missingId;
      }
      ...
      return new CaregiverDashboardItemBinding((MaterialCardView) rootView, adherenceSection,
          ...
          horizontalDetailsLayout, iconAppointmentToday, iconLowStock, iconMissedDose,
          imageViewAvatar, imageViewExpandCollapse, imageViewInsightIcon, imageViewStreakIcon,
          insightPreviewCard, labelAppointmentToday, labelLowStock, labelMissedDose, lowStockLayout,
          mainContentLayout, missedDoseLayout, progressAdherence, progressToday, statusBar,
          statusIndicatorsLayout, streakLayout, textViewAdherenceLabel, textViewAdherencePercentage,
          textViewAgeAndSex, textViewDependentName, textViewInsightCount, textViewInsightPreview,
          textViewInsightTitle, textViewNextDose, textViewStreakCount, textViewTodayProgressLabel);
    }
