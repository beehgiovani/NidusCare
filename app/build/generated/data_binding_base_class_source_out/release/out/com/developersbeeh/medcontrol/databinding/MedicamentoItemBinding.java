...
public final class MedicamentoItemBinding implements ViewBinding {
  ...
  private MedicamentoItemBinding(@NonNull MaterialCardView rootView,
      ...
      @NonNull LinearLayout anotacoesLayout, @NonNull MaterialButton buttonDelete,
      @NonNull MaterialButton buttonEdit, @NonNull MaterialButton buttonMarkAsTaken,
      @NonNull MaterialButton buttonPausePlay, @NonNull MaterialButton buttonRefill,
      @NonNull LinearLayout detailsLayout, @NonNull LinearLayout estoqueLayout,
      @NonNull ImageView iconStatus, @NonNull ImageView iconTipoMedicamento,
      @NonNull ImageView imageViewExpandCollapse, @NonNull LinearLayout mainInfoLayout,
      @NonNull LinearProgressIndicator progressAdherence,
  ...
  public static MedicamentoItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MedicamentoItemBinding((MaterialCardView) rootView, actionsLayout, adherenceGroup,
          anotacoesLayout, buttonDelete, buttonEdit, buttonMarkAsTaken, buttonPausePlay,
          buttonRefill, detailsLayout, estoqueLayout, iconStatus, iconTipoMedicamento,
