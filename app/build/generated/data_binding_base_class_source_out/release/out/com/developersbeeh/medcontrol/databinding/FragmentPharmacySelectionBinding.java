...
public final class FragmentPharmacySelectionBinding implements ViewBinding {
  ...
  private FragmentPharmacySelectionBinding(@NonNull ConstraintLayout rootView,
      @NonNull Chip chip1km, @NonNull Chip chip2km, @NonNull Chip chip5km,
      @NonNull ChipGroup chipGroupDistance, @NonNull HorizontalScrollView filtersScrollView,
      @NonNull LayoutErrorStateBinding layoutError, @NonNull LinearProgressIndicator progressBar,
      @NonNull RecyclerView recyclerViewPharmacies, @NonNull TextView textViewTitle) {
  ...
  public static FragmentPharmacySelectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPharmacySelectionBinding((ConstraintLayout) rootView, chip1km, chip2km,
          chip5km, chipGroupDistance, filtersScrollView, binding_layoutError, progressBar,
          recyclerViewPharmacies, textViewTitle);
    }
