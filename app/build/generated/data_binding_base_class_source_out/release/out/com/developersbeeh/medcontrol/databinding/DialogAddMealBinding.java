  ...
  public static DialogAddMealBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddMealBinding((ScrollView) rootView, buttonAnalyzeWithCamera, dividerAi,
          editTextCalories, editTextDescription, layoutAiResults, progressBarAnalysis, radioAlmoco,
          radioCafeDaManha, radioGroupMealType, radioJantar, radioLanche, textViewBenefits,
          textViewTips, tilCalories, tilDescription);
    }
