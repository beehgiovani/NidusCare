...
public abstract class Hilt_ManageCaregiversFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManageCaregiversFragment() {
    super();
  }

  Hilt_ManageCaregiversFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManageCaregiversFragment_GeneratedInjector) this.generatedComponent()).injectManageCaregiversFragment(UnsafeCasts.<ManageCaregiversFragment>unsafeCast(this));
    }
  }
