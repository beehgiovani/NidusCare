...
public abstract class Hilt_NotificationSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationSettingsFragment() {
    super();
  }

  Hilt_NotificationSettingsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationSettingsFragment_GeneratedInjector) this.generatedComponent()).injectNotificationSettingsFragment(UnsafeCasts.<NotificationSettingsFragment>unsafeCast(this));
    }
  }
