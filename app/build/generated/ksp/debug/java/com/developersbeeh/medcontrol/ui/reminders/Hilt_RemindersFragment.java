...
public abstract class Hilt_RemindersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RemindersFragment() {
    super();
  }

  Hilt_RemindersFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RemindersFragment_GeneratedInjector) this.generatedComponent()).injectRemindersFragment(UnsafeCasts.<RemindersFragment>unsafeCast(this));
    }
  }
