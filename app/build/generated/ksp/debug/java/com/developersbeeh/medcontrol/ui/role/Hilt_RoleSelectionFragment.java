...
public abstract class Hilt_RoleSelectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoleSelectionFragment() {
    super();
  }

  Hilt_RoleSelectionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoleSelectionFragment_GeneratedInjector) this.generatedComponent()).injectRoleSelectionFragment(UnsafeCasts.<RoleSelectionFragment>unsafeCast(this));
    }
  }
