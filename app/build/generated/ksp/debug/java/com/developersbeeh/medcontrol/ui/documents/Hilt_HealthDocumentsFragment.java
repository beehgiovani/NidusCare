...
public abstract class Hilt_HealthDocumentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthDocumentsFragment() {
    super();
  }

  Hilt_HealthDocumentsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthDocumentsFragment_GeneratedInjector) this.generatedComponent()).injectHealthDocumentsFragment(UnsafeCasts.<HealthDocumentsFragment>unsafeCast(this));
    }
  }
