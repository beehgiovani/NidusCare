...
public abstract class Hilt_HealthScheduleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthScheduleFragment() {
    super();
  }

  Hilt_HealthScheduleFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthScheduleFragment_GeneratedInjector) this.generatedComponent()).injectHealthScheduleFragment(UnsafeCasts.<HealthScheduleFragment>unsafeCast(this));
    }
  }
