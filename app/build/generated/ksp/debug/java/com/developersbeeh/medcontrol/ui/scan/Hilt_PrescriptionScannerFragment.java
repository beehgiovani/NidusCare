...
public abstract class Hilt_PrescriptionScannerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrescriptionScannerFragment() {
    super();
  }

  Hilt_PrescriptionScannerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrescriptionScannerFragment_GeneratedInjector) this.generatedComponent()).injectPrescriptionScannerFragment(UnsafeCasts.<PrescriptionScannerFragment>unsafeCast(this));
    }
  }
