...
public abstract class Hilt_TimelineFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TimelineFragment() {
    super();
  }

  Hilt_TimelineFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TimelineFragment_GeneratedInjector) this.generatedComponent()).injectTimelineFragment(UnsafeCasts.<TimelineFragment>unsafeCast(this));
    }
  }
