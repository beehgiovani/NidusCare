...
public abstract class Hilt_HealthGoalsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthGoalsFragment() {
    super();
  }

  Hilt_HealthGoalsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthGoalsFragment_GeneratedInjector) this.generatedComponent()).injectHealthGoalsFragment(UnsafeCasts.<HealthGoalsFragment>unsafeCast(this));
    }
  }
