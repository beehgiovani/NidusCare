...
public abstract class Hilt_WeightTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeightTrackerFragment() {
    super();
  }

  Hilt_WeightTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeightTrackerFragment_GeneratedInjector) this.generatedComponent()).injectWeightTrackerFragment(UnsafeCasts.<WeightTrackerFragment>unsafeCast(this));
    }
  }
