...
public abstract class Hilt_AddEditDocumentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditDocumentFragment() {
    super();
  }

  Hilt_AddEditDocumentFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditDocumentFragment_GeneratedInjector) this.generatedComponent()).injectAddEditDocumentFragment(UnsafeCasts.<AddEditDocumentFragment>unsafeCast(this));
    }
  }
