...
public abstract class Hilt_PhysicalActivityTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhysicalActivityTrackerFragment() {
    super();
  }

  Hilt_PhysicalActivityTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhysicalActivityTrackerFragment_GeneratedInjector) this.generatedComponent()).injectPhysicalActivityTrackerFragment(UnsafeCasts.<PhysicalActivityTrackerFragment>unsafeCast(this));
    }
  }
