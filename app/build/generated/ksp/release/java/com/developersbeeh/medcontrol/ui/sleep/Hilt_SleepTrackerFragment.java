...
public abstract class Hilt_SleepTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SleepTrackerFragment() {
    super();
  }

  Hilt_SleepTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SleepTrackerFragment_GeneratedInjector) this.generatedComponent()).injectSleepTrackerFragment(UnsafeCasts.<SleepTrackerFragment>unsafeCast(this));
    }
  }
