...
public abstract class Hilt_GeriatricCareFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GeriatricCareFragment() {
    super();
  }

  Hilt_GeriatricCareFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GeriatricCareFragment_GeneratedInjector) this.generatedComponent()).injectGeriatricCareFragment(UnsafeCasts.<GeriatricCareFragment>unsafeCast(this));
    }
  }
