...
public abstract class Hilt_DashboardDependenteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DashboardDependenteFragment() {
    super();
  }

  Hilt_DashboardDependenteFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DashboardDependenteFragment_GeneratedInjector) this.generatedComponent()).injectDashboardDependenteFragment(UnsafeCasts.<DashboardDependenteFragment>unsafeCast(this));
    }
  }
