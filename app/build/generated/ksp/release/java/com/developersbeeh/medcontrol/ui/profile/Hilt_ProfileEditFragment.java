...
public abstract class Hilt_ProfileEditFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfileEditFragment() {
    super();
  }

  Hilt_ProfileEditFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileEditFragment_GeneratedInjector) this.generatedComponent()).injectProfileEditFragment(UnsafeCasts.<ProfileEditFragment>unsafeCast(this));
    }
  }
