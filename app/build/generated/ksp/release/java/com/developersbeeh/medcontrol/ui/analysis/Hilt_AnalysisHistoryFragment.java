...
public abstract class Hilt_AnalysisHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnalysisHistoryFragment() {
    super();
  }

  Hilt_AnalysisHistoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnalysisHistoryFragment_GeneratedInjector) this.generatedComponent()).injectAnalysisHistoryFragment(UnsafeCasts.<AnalysisHistoryFragment>unsafeCast(this));
    }
  }
