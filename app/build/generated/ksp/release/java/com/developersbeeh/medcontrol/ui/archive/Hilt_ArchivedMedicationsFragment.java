...
public abstract class Hilt_ArchivedMedicationsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ArchivedMedicationsFragment() {
    super();
  }

  Hilt_ArchivedMedicationsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ArchivedMedicationsFragment_GeneratedInjector) this.generatedComponent()).injectArchivedMedicationsFragment(UnsafeCasts.<ArchivedMedicationsFragment>unsafeCast(this));
    }
  }
