...
public abstract class Hilt_MedicamentoDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MedicamentoDetailFragment() {
    super();
  }

  Hilt_MedicamentoDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedicamentoDetailFragment_GeneratedInjector) this.generatedComponent()).injectMedicamentoDetailFragment(UnsafeCasts.<MedicamentoDetailFragment>unsafeCast(this));
    }
  }
