...
public abstract class Hilt_MealTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MealTrackerFragment() {
    super();
  }

  Hilt_MealTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MealTrackerFragment_GeneratedInjector) this.generatedComponent()).injectMealTrackerFragment(UnsafeCasts.<MealTrackerFragment>unsafeCast(this));
    }
  }
