...
public abstract class Hilt_DependentDiaryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DependentDiaryFragment() {
    super();
  }

  Hilt_DependentDiaryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DependentDiaryFragment_GeneratedInjector) this.generatedComponent()).injectDependentDiaryFragment(UnsafeCasts.<DependentDiaryFragment>unsafeCast(this));
    }
  }
