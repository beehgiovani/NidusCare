...
public abstract class Hilt_CompleteProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CompleteProfileFragment() {
    super();
  }

  Hilt_CompleteProfileFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CompleteProfileFragment_GeneratedInjector) this.generatedComponent()).injectCompleteProfileFragment(UnsafeCasts.<CompleteProfileFragment>unsafeCast(this));
    }
  }
