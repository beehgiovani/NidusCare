...
public abstract class Hilt_AddHealthNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddHealthNoteFragment() {
    super();
  }

  Hilt_AddHealthNoteFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddHealthNoteFragment_GeneratedInjector) this.generatedComponent()).injectAddHealthNoteFragment(UnsafeCasts.<AddHealthNoteFragment>unsafeCast(this));
    }
  }
