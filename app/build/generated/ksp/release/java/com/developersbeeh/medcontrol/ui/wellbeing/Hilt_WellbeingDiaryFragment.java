...
public abstract class Hilt_WellbeingDiaryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WellbeingDiaryFragment() {
    super();
  }

  Hilt_WellbeingDiaryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WellbeingDiaryFragment_GeneratedInjector) this.generatedComponent()).injectWellbeingDiaryFragment(UnsafeCasts.<WellbeingDiaryFragment>unsafeCast(this));
    }
  }
