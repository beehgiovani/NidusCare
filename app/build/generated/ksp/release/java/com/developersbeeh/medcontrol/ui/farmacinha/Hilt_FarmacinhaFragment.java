...
public abstract class Hilt_FarmacinhaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FarmacinhaFragment() {
    super();
  }

  Hilt_FarmacinhaFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FarmacinhaFragment_GeneratedInjector) this.generatedComponent()).injectFarmacinhaFragment(UnsafeCasts.<FarmacinhaFragment>unsafeCast(this));
    }
  }
