...
public abstract class Hilt_PremiumPlansFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PremiumPlansFragment() {
    super();
  }

  Hilt_PremiumPlansFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PremiumPlansFragment_GeneratedInjector) this.generatedComponent()).injectPremiumPlansFragment(UnsafeCasts.<PremiumPlansFragment>unsafeCast(this));
    }
  }
