...
public abstract class Hilt_DoseHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DoseHistoryFragment() {
    super();
  }

  Hilt_DoseHistoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DoseHistoryFragment_GeneratedInjector) this.generatedComponent()).injectDoseHistoryFragment(UnsafeCasts.<DoseHistoryFragment>unsafeCast(this));
    }
  }
