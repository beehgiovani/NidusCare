...
public abstract class Hilt_SearchMedicamentosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchMedicamentosFragment() {
    super();
  }

  Hilt_SearchMedicamentosFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchMedicamentosFragment_GeneratedInjector) this.generatedComponent()).injectSearchMedicamentosFragment(UnsafeCasts.<SearchMedicamentosFragment>unsafeCast(this));
    }
  }
