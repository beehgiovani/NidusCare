...
public abstract class Hilt_AdherenceReportFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdherenceReportFragment() {
    super();
  }

  Hilt_AdherenceReportFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdherenceReportFragment_GeneratedInjector) this.generatedComponent()).injectAdherenceReportFragment(UnsafeCasts.<AdherenceReportFragment>unsafeCast(this));
    }
  }
