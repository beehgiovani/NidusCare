...
public abstract class Hilt_PharmacyMedicationSelectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PharmacyMedicationSelectionFragment() {
    super();
  }

  Hilt_PharmacyMedicationSelectionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PharmacyMedicationSelectionFragment_GeneratedInjector) this.generatedComponent()).injectPharmacyMedicationSelectionFragment(UnsafeCasts.<PharmacyMedicationSelectionFragment>unsafeCast(this));
    }
  }
