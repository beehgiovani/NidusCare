...
public abstract class Hilt_AddEditScheduleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditScheduleFragment() {
    super();
  }

  Hilt_AddEditScheduleFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditScheduleFragment_GeneratedInjector) this.generatedComponent()).injectAddEditScheduleFragment(UnsafeCasts.<AddEditScheduleFragment>unsafeCast(this));
    }
  }
