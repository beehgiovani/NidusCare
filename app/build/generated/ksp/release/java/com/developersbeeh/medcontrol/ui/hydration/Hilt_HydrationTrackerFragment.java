...
public abstract class Hilt_HydrationTrackerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HydrationTrackerFragment() {
    super();
  }

  Hilt_HydrationTrackerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HydrationTrackerFragment_GeneratedInjector) this.generatedComponent()).injectHydrationTrackerFragment(UnsafeCasts.<HydrationTrackerFragment>unsafeCast(this));
    }
  }
